...
int main() {
    const char* inputFile = "map.bmp";
    const char* outputFile = "output_grayscale_map.bmp";
    const int IMAGE_WIDTH = 4183;
    const int IMAGE_HEIGHT = 4183;
    const char* memFile = "output_image_map.mem";
    const char* edgeFile = "output_edge_map.bmp";        // 엣지 검출 BMP 파일 추가
